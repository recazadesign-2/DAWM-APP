...
INSERT INTO public.app_settings (key, value, description) VALUES
  ('ads_enabled', 'false'::jsonb, 'Enable/disable ads'),
  ('maintenance_mode', 'false'::jsonb, 'Maintenance mode');

INSERT INTO public.dynamic_strings (key, value, screen, description) VALUES
  ('home.app_name', 'داوم', 'home', 'App name'),
  ('home.ayah_label', 'آية اليوم', 'home', 'Ayah card label'),
  ('home.dhikr_morning', 'أذكار الصباح', 'home', 'Morning dhikr card'),
  ('home.dhikr_evening', 'أذكار المساء', 'home', 'Evening dhikr card'),
  ('home.dhikr_card_title', 'أوراد الأذكار', 'home', 'Dhikr card title'),
  ('home.dhikr_card_subtitle', 'أكمل أذكارك الصباحية والمسائية', 'home', 'Dhikr card subtitle');
